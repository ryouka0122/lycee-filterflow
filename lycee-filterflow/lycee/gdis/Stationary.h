...
namespace lycee {
	...
	namespace graphics {
		...
		// Pen class
		//
		class Pen : public virtual GdiTool {
		public:
			typedef typename GdiTool::gui_callback gui_callback;
		...
		// Brush class
		//
		class Brush : public virtual GdiTool {
		public:
			typedef typename GdiTool::gui_callback gui_callback;
		...
		// Pencil class
		//
		class Pencil : public virtual GdiTool {
		public:
			typedef typename GdiTool::gui_callback gui_callback;
		...
		// Font class
		//
		class Font : public virtual GdiTool {
		public:
			typedef typename GdiTool::gui_callback gui_callback;
